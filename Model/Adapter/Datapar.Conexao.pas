...
type
  ...
  TDataparContext = class
    strict private
      ...
      public function executaSQL(ACommand: TDataParCommand): TDataSet;
...
function TDataparContext.executaSQL(ACommand: TDataParCommand): TDataSet;
begin
  Result := self.FQuery.executaSQL(ACommand);
end;
